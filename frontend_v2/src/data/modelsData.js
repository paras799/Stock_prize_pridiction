export const MODELS_LIST = [
  {
    ...
    shortDesc: 'Predicts closing stock price using a foundational single-variable linear relationship with Opening price.',
    iconName: 'TrendingUp',
    ...
    howItWorks: [
      ...
      { step: 4, title: 'Pattern Learning', desc: 'Establishes linear coefficient relationship β₁ between Open and Close.' },
